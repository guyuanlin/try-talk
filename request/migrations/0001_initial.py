    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.TextField(null=True, verbose_name='header', blank=True)),
                ('url_params', models.TextField(null=True, verbose_name='url params', blank=True)),
                ('post_params', models.TextField(null=True, verbose_name='post params', blank=True)),
            ...
            options={
                'ordering': ('-time',),
                'verbose_name': 'HTTP Requests \u7d00\u9304',
                'verbose_name_plural': 'HTTP Requests \u7d00\u9304',
            },
        ),
    ]
